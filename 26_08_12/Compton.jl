...
function bounds_ria(this::Compton,Ef⁻::Float64,Ef⁺::Float64,Ei::Float64,type::String,Ui::Float64)
    # Scattered photon
    if type == "S" 
        # ddcs_ria_heaviside returns 0 if Ef > Ei - min(Ui)
        # ddcs_ria_subshell returns 0 if Ef > Ei - Ui_s
    ...
    elseif type == "P"
        ...
        error("Unknown type of method for impulse_approximation scattering.")
    end
    return Ef⁻,Ef⁺,isSkip
end
