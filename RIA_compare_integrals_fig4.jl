...
GaussChebyshev3_yvals = (E/Z)*2*pi*[GaussChebyshev3_integrate_ddcs_over_mu(E_f) for E_f in E_f_vals]
GaussChebyshev4_yvals = (E/Z)*2*pi*[GaussChebyshev4_integrate_ddcs_over_mu(E_f) for E_f in E_f_vals]
GaussJacobi_yvals = (E/Z)*2*pi*[GaussJacobi_integrate_ddcs_over_mu(E_f, alpha, beta) for E_f in E_f_vals]
